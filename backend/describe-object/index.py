...
- Используй ВСЕ переданные характеристики — не придумывай то, чего нет в данных
...
- Если черновик/тезисы пользователя указаны — органично встрой их смысл внутрь абзацев, НЕ выноси их отдельным блоком в начало или конец текста
