export const FEATURES = [
  ...
  },
  {
    icon: "FolderOpen",
    title: "База / Проекты",
    desc: "Актуальные предложения от собственников и застройщиков. Выбери объект, зафиксируй клиента и работай напрямую.",
    ...
    utp: ["Объекты от собственников и застройщиков", "Фиксация клиента в один клик", "Работа напрямую без посредников", "Регулярное обновление базы"],
  },
  {
    icon: "Star",
  ...
  },
  {
    ...
    desc: "Публичный рейтинг брокеров по активности, сделкам и отзывам — повышай репутацию и привлекай больше клиентов.",
    color: "text-pink-400",
    ...
    utp: ["Открытый рейтинг среди коллег", "Рост позиций за активность и сделки", "Отзывы от клиентов и партнёров", "Видимость для новых клиентов"],
  },
  {
    icon: "TrendingUp",
