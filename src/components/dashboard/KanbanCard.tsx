import { type Lead, type FunnelStage, formatDate } from "./leadCard.types"
...
import { FUNNEL_STAGES } from "./leadCard.types"
      ...
      <div className="flex items-center justify-between mt-3 pt-2 border-t border-[#1a1a1a]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="h-6 w-6 flex items-center justify-center rounded-full text-gray-600 hover:text-red-400 transition-colors"
            title="Удалить"
          >
