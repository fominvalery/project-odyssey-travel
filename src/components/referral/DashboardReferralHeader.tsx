        ...
        <div className="rounded-2xl bg-[#111111] border border-[#1f1f1f] p-5 mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-[#0a0a0a] rounded-xl p-3 text-center">
              ...
              <p className="text-[10px] text-blue-400">+{myRating.deal_count * 50} pts</p>
            </div>
            <div className="bg-[#0a0a0a] rounded-xl p-3 text-center">
              ...
              <p className="text-[10px] text-emerald-400">+{myRating.active_listings * 5} pts</p>
            </div>
            <div className="bg-[#0a0a0a] rounded-xl p-3 text-center">
              ...
              <p className="text-[10px] text-violet-400">+{myRating.months_on_platform} pts</p>
            </div>
            <div className="bg-[#0a0a0a] rounded-xl p-3 text-center">
              ...
              <p className="text-[10px] text-amber-400">+{myRating.profile_score} pts</p>
            </div>
          </div>
        </div>
      ) : ratingLoading ? (
