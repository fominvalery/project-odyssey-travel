...
const plans = [
  ...
  },
  {
    ...
    price: "990 ₽",
    period: "в месяц",
    description: "Для максимальной пользы",
    color: "border-violet-500/50",
    accentColor: "text-violet-400",
    badgeBg: "bg-violet-500/20 text-violet-300",
    buttonClass: "bg-violet-600 hover:bg-violet-700 text-white",
    features: [
      { text: "Всё что в тарифе Базовый", included: true },
      { text: "Размещение объявлений безлимитно", included: true },
      { text: "CRM система", included: true },
      { text: "Дашборд", included: true },
      { text: "Аналитика", included: true },
      { text: "Чат Клуба", included: true },
      { text: "Партнёрские сделки", included: true },
    ],
  },
  {
    id: "proplus",
