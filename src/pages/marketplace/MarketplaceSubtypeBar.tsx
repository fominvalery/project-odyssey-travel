...
export default function MarketplaceSubtypeBar({
  ...
  if (activeCategory === "Жилая") {
    const URBAN = ["Квартира", "Студия", "Апартаменты", "Лофт", "Комната", "Многокомнатная квартира"]
    const SUBURBAN = ["Коттедж", "Дом", "Дача", "Частный дом", "Загородный дом", "Часть дома", "Таунхаус", "Дуплекс", "Вилла"]
    const PREMIUM = ["Пентхаус", "Элитная квартира", "Премиум-жильё", "Резиденция", "Особняк"]
  ...
  if (activeCategory === "Инвестиционная") {
    ...
    const SHARES = ["Доля в ООО / бизнесе", "Акции / Ценные бумаги", "Займ с фиксированной доходностью", "Облигации", "Коллективная покупка объекта"]
    ...
    return (
      <GroupAndSubtypeRow
        groups={[
          ...
          { id: "land", label: "Земля", subtypes: LAND },
          { id: "shares", label: "Доли / Акции", subtypes: SHARES },
